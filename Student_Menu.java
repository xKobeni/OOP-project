...
public class Student_Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        upcoming.setBounds(160, 140, 480, 168);
        ...
        recent.setBounds(160, 370, 480, 168);
    ...
    private void showevents(){
        ...
        try{
            ...
            query = "SELECT * FROM admin_data_table WHERE 1";
    ...
    private void showannounce() {
        ...
        try{
            ...
            query = "SELECT * FROM admin_data_table WHERE 2";
            rs = st.executeQuery(query);
            ...
            while(rs.next()){
                ...
                if(found == 1){
                    ...
                    aTitle.setText(QTitle);
                    aDate.setText("Date: " + QDate);
                    aTime.setText("Time: " + QTime);
                    aLocation.setText("Location: " +QLocation);
